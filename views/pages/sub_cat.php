...
<td class="buy_button"><div align="center"><a style="color: white; text-decoration: none; text-size: 20;" href="index.php?view=add_to_cart_list_sub_cat&id=<?php echo $item['id']?>">Купить</a></div></td>
</tr>
